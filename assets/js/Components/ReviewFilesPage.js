      ...
      contentReferences.map((reference) => {
        ...
        postContentItemOptions.push(
          createContentItemPostOptions(
            newFullPageHtml,
            extractUrl(reference.contentItemUrl),
    ...
    <>
            ...
            <div className="flex-row gap-2">
              ...
              >
                <LeftArrowIcon
                  className={
                    `icon-sm ` +
                    (filteredFiles.length < 2 ? "gray" : "link-color")
                  }
                />
                <div className="flex-column justify-content-center">
                  {t("fix.button.previous")}
                </div>
              </button>
      ...
      >
        <div className="flex-column h-100">
          ...
          <div className="dialog-footer">
            <div className="subtext align-self-center">
              {t("files.label.selected_count", {
                count: deleteFileQueue.length,
              })}
            </div>
            <div className="flex-row gap-2">
              <button
